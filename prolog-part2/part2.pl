...
get_value([],V,V).
get_value([H|T],V1,V):- up(H), top_key(V1), V2 is V1 + 3, get_value(T,V2,V),!.
get_value([H|T],V1,V):- left(H), left_key(V1), V2 is V1 + 1, get_value(T,V2,V),!.
get_value([H|T],V1,V):- right(H), right_key(V1), V2 is V1 - 1, get_value(T,V2,V),!.
get_value([H|T],V1,V):- down(H), bottom_key(V1), V2 is V1 - 3, get_value(T,V2,V),!.
